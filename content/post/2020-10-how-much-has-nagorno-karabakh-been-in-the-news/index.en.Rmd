...
In the case of the 2020 war in Nagorno Karabakh, the NYT published at most two articles per day mentioning "Karabakh" during the first week of war. Please keep in mind that this is updated to 6 October due limitations in the API offered by the NYT (I may update this graph in the coming days).
...
karabakh_df_base %>% 
  ...
  scale_y_continuous(name = "", breaks = scales::pretty_breaks(2)) +
  labs(title = paste("Number of articles per year mentioning", sQuote("Karabakh"), "on *The New York Times*"),
