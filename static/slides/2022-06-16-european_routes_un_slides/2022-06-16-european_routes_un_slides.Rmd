---
title: "Finding the busiest European plane routes that can be travelled by train, with coordinates and identifiers"
# subtitle: ""
...
- there are slightly different stats, not all of them available for all countries
  - We opted for "passengers carried (departures)", which is mostly available
      - but e.g. not for Turkey, for which we had to rely on  “passengers carried” (PAS_CRD)
